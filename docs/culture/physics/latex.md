...
开三定律 $\frac{a^3}{T^2}=k$
万有引力公式 $F_\text{万}=G\frac{Mm}{r^2}=m\frac{v^2}{r}=mω^2r=m(\frac{2π}{T})^2 r$

GM恒等式(匀速圆周) $GM=v^2 r=ω^2 r^3=(\frac{2π}{t})^2 r^3=gR_0^2$ , 其中 $R_0$ 指天体半径
使用条件：匀速圆周运动 中央天体静止

轨道速度周期口诀：高轨低速长周期 其中速同时指 $v\text{, }ω\text{, }a$
第一宇宙速度 $v=\sqrt{gR_0}$ 其中 $R_0$ 指天体半径
...
动能定理 $ΣW_{\text{外}i}=E_{k\text{末}}-E_{k\text{初}}$

机械能守恒条件：无外力做功
外力：除重力与弹力之外的力

能量守恒定律 $E_\text{增}=E_\text{减}$ 
重力做功 $W_G=mgh=-E_p G$
力做功功率 $P=\frac{W}{t}$
恒力和速度求功率 $P=Fv$
...
动量定义式 $p=mv$
冲量定义式 $I=Ft$
动量定理 $ΣI_{\text{外}i}=p_\text{末}-p_\text{初}$
动量守恒条件：整体合外力为0
...
单摆周期公式 $T=2π\sqrt{\frac{L}{g}}$
单摆求重力加速度 $g={(\frac{4π^2}{T})}^2 L$
