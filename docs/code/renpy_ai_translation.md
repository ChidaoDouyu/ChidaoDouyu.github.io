...
2. 选择 `高级选项` -> `解压游戏包`
![导航](assets/687698f7bb631.png)
3. 确认文件文本框为空
将游戏 `unrpy` 副本的可执行程序拖动到文件白框中
并再次确认白框中是否仅有刚刚选中的 `.exe` 文件
4. 勾选下方全部三个复选框
5. 点击 `解包`
![解包](assets/687699e7885a5.png)
6. 等待解包完成
期间不要移动修改任何文件
7. **检查日志**
